...
import PasswordChangeAfterResetPage from './pages/PasswordChangeAfterResetPage';
        ...
        <div className="relative min-h-screen bg-[#1e1e1e]">
          ...
          <main className={`main-content ${isSidebarOpen ? 'sidebar-open' : ''}`}>
            <Routes>
              ...
              {/* DO NOT CHANGE */}
              {/* password_change path is autogenerated by lemmy and cannot be changed */}
              <Route path="/password_change/:reset_token" element={<PasswordChangeAfterResetPage />} />
