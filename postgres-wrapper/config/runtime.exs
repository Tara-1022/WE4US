...
#
#     PHX_SERVER=true bin/we4us start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
if System.get_env("PHX_SERVER") do
  config :we4us, We4usWeb.Endpoint, server: true
end
...
if config_env() == :prod do
  ...
  # Get host, scheme, and port from environment variables with sensible defaults
  host = System.get_env("PHX_HOST") || "we4us.co.in"
  scheme = System.get_env("PHX_SCHEME") || "https" 
  port = String.to_integer(System.get_env("PHX_PORT") || "443")

  config :we4us, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
